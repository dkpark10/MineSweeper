...
var ButtonHandler = /** @class */ (function () {
    ...
    ButtonHandler.prototype.chainConflict = function (y, x) {
        ...
        ret.push({
            y: y,
            x: x,
            status: cellNumber ? commonutility_1.EventStatus.NUMBERCELL : commonutility_1.EventStatus.DISABLED,
            num: cellNumber
        });
        while (q.length) {
            var currenty = q[0].y;
            ...
            for (var dir = 0; dir < 8; dir++) {
                ...
                if (this.board[y][x].aroundNumber === 0 && this.board[y][x].visited !== false) {
                    ...
                    ret.push({
                        y: nexty,
                        x: nextx,
                        status: nextCellNumber ? commonutility_1.EventStatus.NUMBERCELL : commonutility_1.EventStatus.DISABLED,
                        num: nextCellNumber
                    });
